...
Setup script of the `pyeufacility` module.
...
# *since*:        Sun Nov  22 16:18:40 2020
...
PACKURL             = 'https://github.com/eurostat/basic-services/src/python'
DESCRIPTION         = 'Python package supporting the automated ingestion and harmonisation of \
    pan-European datasets on basic services (e.g., education facilities, healthcare serices)  \
    made openly available by national/regional/local authorities.'
VERSION             = None
